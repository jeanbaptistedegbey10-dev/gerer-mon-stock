  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="md:hidden bg-white border-b border-gray-100
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-amber-400 rounded flex items-center
                            justify-center">
        ...
        {/* Pages — Outlet remplacé par la page active */}
